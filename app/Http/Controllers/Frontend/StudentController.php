...
class StudentController extends Controller
{
    ...
    protected function persistantData()
    {
        ...
        foreach ($topleveldir as $value) {
            ...
            $schooldata = ['school_name' => $schooldatainfo['schoolname'], 'total_files' => count($tootalfiles)];
    ...
    protected function persistentSchoolFile(String $id, String $school_grade, String $subject)
    {
        ...
        foreach ($second_level_dir as $value) {
            ...
            $school_data_subject = [
                ...
                'subject_files_destination' => str_replace('public', '', $value),
                'file_property' => [
    ...
    public function searchSchool(Request $request)
    {
        ...
        // $search_result->withPath('gust/search/');
